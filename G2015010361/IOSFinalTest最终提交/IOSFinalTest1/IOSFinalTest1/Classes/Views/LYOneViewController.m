...
- (void)viewDidLoad {
    ...
    = [[UIImageView alloc] initWithFrame:CGRectMake(60, presentButton.frame.origin.y + presentButton.frame.size.height + 10,self.view.frame.size.width - 160, 100)];
    ...
    label.text = @"工程师，您好：\n navigation1包括测试题的 第2题，第3题（3.10相信您在登陆界面已经检查过了）\n navigation2 是第4题 \n navigation3是第5题 \n nagivation4是第6题\n navigation5是第8，9，10题 \n另外，第7题在整个结构中\n 祝您生活愉快，身体健康";
