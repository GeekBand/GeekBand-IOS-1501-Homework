    ...
    dispatch_async(addQueue, ^{
        ...
        for (NSInteger idx1 = 0; idx1 < number; idx1++) {
            ...
            for (NSInteger idx2 = 0; idx2 < 1000; idx2++) {
                ...
                newClassmate.avatar = UIImagePNGRepresentation([UIImage imageNamed:@"deault_avatar"]);
...
// RLMRealm objects are not thread safe and cannot be shared across threads.
// Update 1000 items each time and very carefully.
// A safe way is segue a modal view to show progress, and prevent user do something with data.
+ (void)updateAllClassmateRandomly{
    ...
    dispatch_async(updateQueue, ^{
        ...
        unsigned int divisionByThousand  = (unsigned int)number / 1000;
