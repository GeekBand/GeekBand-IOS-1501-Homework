...
+ (NSString *)createARandomName {
    ...
    firstName =[firstName substringToIndex:MAX(3, (arc4random() % firstName.length))];
...
+ (NSString *)createARandomText {
    ...
    // Remove the first and last space of text
    randomText = [randomText substringWithRange:NSMakeRange(1, randomText.length - 2)];
