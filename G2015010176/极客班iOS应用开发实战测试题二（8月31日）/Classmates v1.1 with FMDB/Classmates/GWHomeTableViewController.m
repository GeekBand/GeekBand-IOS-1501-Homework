...
- (void)viewDidLoad {
    ...
    // Add a database, query all data from database
    GWClassmateDBManager *cdbm = [[GWClassmateDBManager alloc] init];
    [cdbm createClassmateTable];
    self.resultsArray = [cdbm getAllClassmate];
    
    [self.tableView reloadData];
    
    NSLog(@"%@",[GWArchiver getPathWithinDocumentDir:@"Sandbox Path"]);
